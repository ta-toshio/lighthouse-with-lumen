...
class LighthouseServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom(base_path().'/vendor/nuwave/lighthouse/config/config.php', 'lighthouse');

        $this->publishes([
            base_path().'/vendor/nuwave/lighthouse/config/config.php' => base_path('config').'/lighthouse.php',
        ], 'config');

        $this->publishes([
            base_path().'/vendor/nuwave/lighthouse/assets/default-schema.graphql' => config('lighthouse.schema.register'),
        ], 'schema');

        if (config('lighthouse.controller')) {
            $this->loadRoutesFrom(base_path().'/vendor/nuwave/lighthouse/src/Support/Http/routes.php');
        }
